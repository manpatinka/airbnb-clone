            ...
            <div className='absolute inset-0 bg-black text-white min-h-screen'>
                <div className='p-8 grid gap-4 bg-black'>
                    <div>
                        ...
                        <button onClick={() => setShowAllPhotos(false)} className='fixed top-8 right-12 flex gap-1 py-2 px-4 rounded-2xl shadow shadow-black bg-white text-black'>
    ...
    return (
        <div className='mt-4 bg-gray-100 -mx-8 px-8 pt-8'>
            ...
            <div className="relative">
                ...
                <button onClick={() => setShowAllPhotos(true)} className="flex gap-1 absolute bottom-0 right-0 py-2 px-4 bg-white rounded-2xl shadow shadow-md shadow-gray-500">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
